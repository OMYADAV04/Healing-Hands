...
public class ALL_Patient_Info extends JFrame {
    ...
    public ALL_Patient_Info() {
        setUndecorated(true);
        setSize(1050, 650); // Standardized workspace size

        // Positioned to fit the content area next to the sidebar
        setLocation(320, 180);
        ...
        // --- TOP HEADER (With Real-Time Search) ---
        ...
        JLabel title = new JLabel("ALL PATIENT RECORDS");
        ...
        table.setRowHeight(40); // Spacious rows for medical records
        table.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        table.setShowVerticalLines(false);
        table.setGridColor(new Color(230, 230, 230));

        // Center Alignment & Zebra Striping
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            @Override
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                Component c = super.getTableCellRendererComponent(table, value, isSelected, hasFocus, row, column);
                if (!isSelected) {
                    // Alternating colors to help eye tracking across many columns
            ...
            searchField.addKeyListener(new KeyAdapter() {
                ...
                public void keyReleased(KeyEvent e) {
                    ...
                    if (text.trim().isEmpty()) {
                        ...
                        // Filters by Name, Disease, Room No, or ID
